#!/bin/bash
#qemu-system-x86_64 -hda Image/x64BareBonesImage.qcow2 -device rtl8139,netdev=net0,mac=DE:AD:BE:EF:11:11 -netdev tap,id=net0,ifname=tap0,script=no,downscript=no
